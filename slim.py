...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/slim2.git")
			os.system("rm -rf slimfb.py")
			os.system("cp -f DARLIHOT/slim.py \\.")
